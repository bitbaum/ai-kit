...
import { modelCost, modelCostAt, paidModelsIn, freeChain } from 'ai-ration';
...
const routed = { id: 'openrouter', baseUrl: 'x', keyEnv: 'K', models: [], dailyTokens: 1, routed: true };
...
test('provider-awareness does NOT weaken the guard where the real incidents were', () => {
  ...
  assert.deepEqual(paidModelsIn(chain), ['anthropic/claude-sonnet-5', 'google/gemini-2.0-flash-001']);
});
